...
from .models import Perfume, Marca, Carrito, ItemCarrito, Pedido, Stock
from .serializer import ( 
    PerfumeSerializer, MarcaSerializer, CarritoSerializer, ItemCarritoSerializer, 
    PedidoSerializer, StockSerializer
)
